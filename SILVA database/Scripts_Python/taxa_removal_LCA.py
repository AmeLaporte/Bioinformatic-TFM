...
def main():
    ...
    filename1="sequence_deleted_"+family+".fasta"
    filename2="troncated_database_"+family+".fasta"
    
    #Output the two fasta files
    outputFasta(unite_file, filename1,filename2, accs_fin)
